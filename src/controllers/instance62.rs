...
pub struct EventInstanceQueries62;

#[Object]
impl EventInstanceQueries62{
    async fn event_instances62(
        &self,
    ) -> Result<Vec<EventInstance62Object>, anyhow::Error> {
        let ret = vec![EventInstance62{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations62;

#[Object]
impl EventInstanceMutations62{
    async fn create62(
        &self,
        _input: EventInstanceCreateInput62,
    ) -> Result<EventInstance62Object, anyhow::Error> {
        let ret = EventInstance62{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput62 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance62);

#[Object(name = "EventInstance62")]
impl EventInstance62Object {
...
simpleObject!(EventInstance62, title: String, description: String);

complexObject!(EventInstance62, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
