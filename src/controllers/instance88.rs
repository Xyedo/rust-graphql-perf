...
pub struct EventInstanceQueries88;

#[Object]
impl EventInstanceQueries88 {
    async fn event_instances88(&self) -> Result<Vec<EventInstance88Object>, anyhow::Error> {
        let ret = vec![EventInstance88 {
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations88;

#[Object]
impl EventInstanceMutations88 {
    async fn create88(&self, _input: EventInstanceCreateInput88) -> Result<EventInstance88Object, anyhow::Error> {
        let ret = EventInstance88 {
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput88 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance88);

#[Object(name = "EventInstance88")]
impl EventInstance88Object {
...
// simpleObject macro: creates a small GraphQL wrapper with two fields
...
// complexObject macro: exposes multiple getters from the underlying type
...
simpleObject!(EventInstance88, title: String, description: String);

complexObject!(EventInstance88, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
