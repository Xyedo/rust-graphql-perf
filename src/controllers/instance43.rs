...
pub struct EventInstanceQueries43;

#[Object]
impl EventInstanceQueries43{
    async fn event_instances43(
        &self,
    ) -> Result<Vec<EventInstance43Object>, anyhow::Error> {
        let ret = vec![EventInstance43{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations43;

#[Object]
impl EventInstanceMutations43{
    async fn create43(
        &self,
        _input: EventInstanceCreateInput43,
    ) -> Result<EventInstance43Object, anyhow::Error> {
        let ret = EventInstance43{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput43 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance43);

#[Object(name = "EventInstance43")]
impl EventInstance43Object {
...
simpleObject!(EventInstance43, title: String, description: String);

complexObject!(EventInstance43, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
