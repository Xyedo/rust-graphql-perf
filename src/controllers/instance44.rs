...
pub struct EventInstanceQueries44;

#[Object]
impl EventInstanceQueries44{
    async fn event_instances44(
        &self,
    ) -> Result<Vec<EventInstance44Object>, anyhow::Error> {
        let ret = vec![EventInstance44{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations44;

#[Object]
impl EventInstanceMutations44{
    async fn create44(
        &self,
        _input: EventInstanceCreateInput44,
    ) -> Result<EventInstance44Object, anyhow::Error> {
        let ret = EventInstance44{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput44 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance44);

#[Object(name = "EventInstance44")]
impl EventInstance44Object {
...
simpleObject!(EventInstance44, title: String, description: String);

complexObject!(EventInstance44, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
