...
pub struct EventInstanceQueries48;

#[Object]
impl EventInstanceQueries48{
    async fn event_instances48(
        &self,
    ) -> Result<Vec<EventInstance48Object>, anyhow::Error> {
        let ret = vec![EventInstance48{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations48;

#[Object]
impl EventInstanceMutations48{
    async fn create48(
        &self,
        _input: EventInstanceCreateInput48,
    ) -> Result<EventInstance48Object, anyhow::Error> {
        let ret = EventInstance48{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput48 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance48);

#[Object(name = "EventInstance48")]
impl EventInstance48Object {
...
simpleObject!(EventInstance48, title: String, description: String);

complexObject!(EventInstance48, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
