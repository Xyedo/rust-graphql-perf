...
derive_graphql_wrapper!(EventInstance5);

#[Object(name = "EventInstance5")]
impl EventInstance5Object {
...
simpleObject!(EventInstance5, title: String, description: String);

complexObject!(EventInstance5, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
