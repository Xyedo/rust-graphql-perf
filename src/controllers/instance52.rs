...
pub struct EventInstanceQueries52;

#[Object]
impl EventInstanceQueries52{
    async fn event_instances52(
        &self,
    ) -> Result<Vec<EventInstance52Object>, anyhow::Error> {
        let ret = vec![EventInstance52{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations52;

#[Object]
impl EventInstanceMutations52{
    async fn create52(
        &self,
        _input: EventInstanceCreateInput52,
    ) -> Result<EventInstance52Object, anyhow::Error> {
        let ret = EventInstance52{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput52 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance52);

#[Object(name = "EventInstance52")]
impl EventInstance52Object {
...
simpleObject!(EventInstance52, title: String, description: String);

complexObject!(EventInstance52, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
