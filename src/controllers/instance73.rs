...
pub struct EventInstanceQueries73;

#[Object]
impl EventInstanceQueries73{
    async fn event_instances73(
        &self,
    ) -> Result<Vec<EventInstance73Object>, anyhow::Error> {
        let ret = vec![EventInstance73{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations73;

#[Object]
impl EventInstanceMutations73{
    async fn create73(
        &self,
        _input: EventInstanceCreateInput73,
    ) -> Result<EventInstance73Object, anyhow::Error> {
        let ret = EventInstance73{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput73 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance73);

#[Object(name = "EventInstance73")]
impl EventInstance73Object {
...
simpleObject!(EventInstance73, title: String, description: String);

complexObject!(EventInstance73, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
