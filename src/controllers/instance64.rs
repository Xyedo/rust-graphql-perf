...
pub struct EventInstanceQueries64;

#[Object]
impl EventInstanceQueries64{
    async fn event_instances64(
        &self,
    ) -> Result<Vec<EventInstance64Object>, anyhow::Error> {
        let ret = vec![EventInstance64{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations64;

#[Object]
impl EventInstanceMutations64{
    async fn create64(
        &self,
        _input: EventInstanceCreateInput64,
    ) -> Result<EventInstance64Object, anyhow::Error> {
        let ret = EventInstance64{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput64 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance64);

#[Object(name = "EventInstance64")]
impl EventInstance64Object {
...
simpleObject!(EventInstance64, title: String, description: String);

complexObject!(EventInstance64, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
