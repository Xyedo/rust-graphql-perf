...
pub struct EventInstanceQueries86;

#[Object]
impl EventInstanceQueries86{
    async fn event_instances86(
        &self,
    ) -> Result<Vec<EventInstance86Object>, anyhow::Error> {
        let ret = vec![EventInstance86{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations86;

#[Object]
impl EventInstanceMutations86{
    async fn create86(
        &self,
        _input: EventInstanceCreateInput86,
    ) -> Result<EventInstance86Object, anyhow::Error> {
        let ret = EventInstance86{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput86 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance86);

#[Object(name = "EventInstance86")]
impl EventInstance86Object {
...
simpleObject!(EventInstance86, title: String, description: String);

complexObject!(EventInstance86, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
