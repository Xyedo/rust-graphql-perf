...
pub struct EventInstanceQueries46;

#[Object]
impl EventInstanceQueries46{
    async fn event_instances46(
        &self,
    ) -> Result<Vec<EventInstance46Object>, anyhow::Error> {
        let ret = vec![EventInstance46{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations46;

#[Object]
impl EventInstanceMutations46{
    async fn create46(
        &self,
        _input: EventInstanceCreateInput46,
    ) -> Result<EventInstance46Object, anyhow::Error> {
        let ret = EventInstance46{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput46 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance46);

#[Object(name = "EventInstance46")]
impl EventInstance46Object {
...
simpleObject!(EventInstance46, title: String, description: String);

complexObject!(EventInstance46, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
