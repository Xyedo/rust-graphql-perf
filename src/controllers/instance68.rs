...
pub struct EventInstanceQueries68;

#[Object]
impl EventInstanceQueries68{
    async fn event_instances68(
        &self,
    ) -> Result<Vec<EventInstance68Object>, anyhow::Error> {
        let ret = vec![EventInstance68{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations68;

#[Object]
impl EventInstanceMutations68{
    async fn create68(
        &self,
        _input: EventInstanceCreateInput68,
    ) -> Result<EventInstance68Object, anyhow::Error> {
        let ret = EventInstance68{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput68 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance68);

#[Object(name = "EventInstance68")]
impl EventInstance68Object {
...
simpleObject!(EventInstance68, title: String, description: String);

complexObject!(EventInstance68, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
