...
pub struct EventInstanceQueries92;

#[Object]
impl EventInstanceQueries92 {
	async fn event_instances92(&self) -> Result<Vec<EventInstance92Object>, anyhow::Error> {
		let ret = vec![EventInstance92 {
			title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations92;

#[Object]
impl EventInstanceMutations92 {
	async fn create92(&self, _input: EventInstanceCreateInput92) -> Result<EventInstance92Object, anyhow::Error> {
		let ret = EventInstance92 {
			title: "a".to_string(),
			description: "a".to_string(),
			from_date: Utc::now(),
			to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput92 {
	title: String,
	description: String,
...
derive_graphql_wrapper!(EventInstance92);

#[Object(name = "EventInstance92")]
impl EventInstance92Object {
...
simpleObject!(EventInstance92, title: String, description: String);

complexObject!(EventInstance92, {
	from_date: DateTime<Utc>,
	to_date: DateTime<Utc>,
	start_transition_mins: i16,
	end_transition_mins: i16,
