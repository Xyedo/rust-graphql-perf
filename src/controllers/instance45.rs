...
pub struct EventInstanceQueries45;

#[Object]
impl EventInstanceQueries45{
    async fn event_instances45(
        &self,
    ) -> Result<Vec<EventInstance45Object>, anyhow::Error> {
        let ret = vec![EventInstance45{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations45;

#[Object]
impl EventInstanceMutations45{
    async fn create45(
        &self,
        _input: EventInstanceCreateInput45,
    ) -> Result<EventInstance45Object, anyhow::Error> {
        let ret = EventInstance45{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput45 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance45);

#[Object(name = "EventInstance45")]
impl EventInstance45Object {
...
simpleObject!(EventInstance45, title: String, description: String);

complexObject!(EventInstance45, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
