...
pub struct EventInstanceQueries20;

#[Object]
impl EventInstanceQueries20{
    async fn event_instances20(
        &self,
    ) -> Result<Vec<EventInstance20Object>, anyhow::Error> {
        let ret = vec![EventInstance20{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations20;

#[Object]
impl EventInstanceMutations20{
    async fn create20(
        &self,
        _input: EventInstanceCreateInput20,
    ) -> Result<EventInstance20Object, anyhow::Error> {
        let ret = EventInstance20{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput20 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance20);

#[Object(name = "EventInstance20")]
impl EventInstance20Object {
...
simpleObject!(EventInstance20, title: String, description: String);

complexObject!(EventInstance20, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
