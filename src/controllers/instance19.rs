...
pub struct EventInstanceQueries19;

#[Object]
impl EventInstanceQueries19{
    async fn event_instances19(
        &self,
    ) -> Result<Vec<EventInstance19Object>, anyhow::Error> {
        let ret = vec![EventInstance19{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations19;

#[Object]
impl EventInstanceMutations19{
    async fn create19(
        &self,
        _input: EventInstanceCreateInput19,
    ) -> Result<EventInstance19Object, anyhow::Error> {
        let ret = EventInstance19{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput19 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance19);

#[Object(name = "EventInstance19")]
impl EventInstance19Object {
...
simpleObject!(EventInstance19, title: String, description: String);

complexObject!(EventInstance19, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
