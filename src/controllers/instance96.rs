...
pub struct EventInstanceQueries96;

#[Object]
impl EventInstanceQueries96 {
	async fn event_instances96(&self) -> Result<Vec<EventInstance96Object>, anyhow::Error> {
		let ret = vec![EventInstance96 {
			title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations96;

#[Object]
impl EventInstanceMutations96 {
	async fn create96(&self, _input: EventInstanceCreateInput96) -> Result<EventInstance96Object, anyhow::Error> {
		let ret = EventInstance96 {
			title: "a".to_string(),
			description: "a".to_string(),
			from_date: Utc::now(),
			to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput96 {
	title: String,
	description: String,
...
derive_graphql_wrapper!(EventInstance96);

#[Object(name = "EventInstance96")]
impl EventInstance96Object {
...
simpleObject!(EventInstance96, title: String, description: String);

complexObject!(EventInstance96, {
	from_date: DateTime<Utc>,
	to_date: DateTime<Utc>,
	start_transition_mins: i16,
	end_transition_mins: i16,
