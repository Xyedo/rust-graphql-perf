...
pub struct EventInstanceQueries97;

#[Object]
impl EventInstanceQueries97 {
    async fn event_instances97(&self) -> Result<Vec<EventInstance97Object>, anyhow::Error> {
        let ret = vec![EventInstance97 {
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations97;

#[Object]
impl EventInstanceMutations97 {
    async fn create97(&self, _input: EventInstanceCreateInput97) -> Result<EventInstance97Object, anyhow::Error> {
        let ret = EventInstance97 {
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput97 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance97);

#[Object(name = "EventInstance97")]
impl EventInstance97Object {
...
simpleObject!(EventInstance97, title: String, description: String);

complexObject!(EventInstance97, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
