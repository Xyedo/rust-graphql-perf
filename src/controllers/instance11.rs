...
pub struct EventInstanceQueries11;

#[Object]
impl EventInstanceQueries11{
    async fn event_instances11(
        &self,
    ) -> Result<Vec<EventInstance11Object>, anyhow::Error> {
        let ret = vec![EventInstance11{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations11;

#[Object]
impl EventInstanceMutations11{
    async fn create11(
        &self,
        _input: EventInstanceCreateInput11,
    ) -> Result<EventInstance11Object, anyhow::Error> {
        let ret = EventInstance11{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput11 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance11);

#[Object(name = "EventInstance11")]
impl EventInstance11Object {
...
simpleObject!(EventInstance11, title: String, description: String);

complexObject!(EventInstance11, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
