...
pub struct EventInstanceQueries26;

#[Object]
impl EventInstanceQueries26{
    async fn event_instances26(
        &self,
    ) -> Result<Vec<EventInstance26Object>, anyhow::Error> {
        let ret = vec![EventInstance26{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations26;

#[Object]
impl EventInstanceMutations26{
    async fn create26(
        &self,
        _input: EventInstanceCreateInput26,
    ) -> Result<EventInstance26Object, anyhow::Error> {
        let ret = EventInstance26{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput26 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance26);

#[Object(name = "EventInstance26")]
impl EventInstance26Object {
...
simpleObject!(EventInstance26, title: String, description: String);

complexObject!(EventInstance26, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
