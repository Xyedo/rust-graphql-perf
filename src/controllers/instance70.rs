...
pub struct EventInstanceQueries70;

#[Object]
impl EventInstanceQueries70{
    async fn event_instances70(
        &self,
    ) -> Result<Vec<EventInstance70Object>, anyhow::Error> {
        let ret = vec![EventInstance70{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations70;

#[Object]
impl EventInstanceMutations70{
    async fn create70(
        &self,
        _input: EventInstanceCreateInput70,
    ) -> Result<EventInstance70Object, anyhow::Error> {
        let ret = EventInstance70{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput70 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance70);

#[Object(name = "EventInstance70")]
impl EventInstance70Object {
...
simpleObject!(EventInstance70, title: String, description: String);

complexObject!(EventInstance70, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
