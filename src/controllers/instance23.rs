...
pub struct EventInstanceQueries23;

#[Object]
impl EventInstanceQueries23{
    async fn event_instances23(
        &self,
    ) -> Result<Vec<EventInstance23Object>, anyhow::Error> {
        let ret = vec![EventInstance23{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations23;

#[Object]
impl EventInstanceMutations23{
    async fn create23(
        &self,
        _input: EventInstanceCreateInput23,
    ) -> Result<EventInstance23Object, anyhow::Error> {
        let ret = EventInstance23{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput23 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance23);

#[Object(name = "EventInstance23")]
impl EventInstance23Object {
...
simpleObject!(EventInstance23, title: String, description: String);

complexObject!(EventInstance23, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
