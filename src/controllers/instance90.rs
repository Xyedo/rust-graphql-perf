...
pub struct EventInstanceQueries90;

#[Object]
impl EventInstanceQueries90{
    async fn event_instances90(
        &self,
    ) -> Result<Vec<EventInstance90Object>, anyhow::Error> {
        let ret = vec![EventInstance90{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations90;

#[Object]
impl EventInstanceMutations90{
    async fn create90(
        &self,
        _input: EventInstanceCreateInput90,
    ) -> Result<EventInstance90Object, anyhow::Error> {
        let ret = EventInstance90{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput90 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance90);

#[Object(name = "EventInstance90")]
impl EventInstance90Object {
...
simpleObject!(EventInstance90, title: String, description: String);

complexObject!(EventInstance90, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
