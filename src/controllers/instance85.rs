...
pub struct EventInstanceQueries85;

#[Object]
impl EventInstanceQueries85{
    async fn event_instances85(
        &self,
    ) -> Result<Vec<EventInstance85Object>, anyhow::Error> {
        let ret = vec![EventInstance85{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations85;

#[Object]
impl EventInstanceMutations85{
    async fn create85(
        &self,
        _input: EventInstanceCreateInput85,
    ) -> Result<EventInstance85Object, anyhow::Error> {
        let ret = EventInstance85{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput85 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance85);

#[Object(name = "EventInstance85")]
impl EventInstance85Object {
...
simpleObject!(EventInstance85, title: String, description: String);

complexObject!(EventInstance85, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
