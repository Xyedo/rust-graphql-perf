...
pub struct EventInstanceQueries75;

#[Object]
impl EventInstanceQueries75{
    async fn event_instances75(
        &self,
    ) -> Result<Vec<EventInstance75Object>, anyhow::Error> {
        let ret = vec![EventInstance75{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations75;

#[Object]
impl EventInstanceMutations75{
    async fn create75(
        &self,
        _input: EventInstanceCreateInput75,
    ) -> Result<EventInstance75Object, anyhow::Error> {
        let ret = EventInstance75{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput75 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance75);

#[Object(name = "EventInstance75")]
impl EventInstance75Object {
...
simpleObject!(EventInstance75, title: String, description: String);

complexObject!(EventInstance75, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
