...
pub struct EventInstanceQueries80;

#[Object]
impl EventInstanceQueries80{
    async fn event_instances80(
        &self,
    ) -> Result<Vec<EventInstance80Object>, anyhow::Error> {
        let ret = vec![EventInstance80{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations80;

#[Object]
impl EventInstanceMutations80{
    async fn create80(
        &self,
        _input: EventInstanceCreateInput80,
    ) -> Result<EventInstance80Object, anyhow::Error> {
        let ret = EventInstance80{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput80 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance80);

#[Object(name = "EventInstance80")]
impl EventInstance80Object {
...
simpleObject!(EventInstance80, title: String, description: String);

complexObject!(EventInstance80, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
