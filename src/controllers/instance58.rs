...
pub struct EventInstanceQueries58;

#[Object]
impl EventInstanceQueries58{
    async fn event_instances58(
        &self,
    ) -> Result<Vec<EventInstance58Object>, anyhow::Error> {
        let ret = vec![EventInstance58{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations58;

#[Object]
impl EventInstanceMutations58{
    async fn create58(
        &self,
        _input: EventInstanceCreateInput58,
    ) -> Result<EventInstance58Object, anyhow::Error> {
        let ret = EventInstance58{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput58 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance58);

#[Object(name = "EventInstance58")]
impl EventInstance58Object {
...
simpleObject!(EventInstance58, title: String, description: String);

complexObject!(EventInstance58, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
