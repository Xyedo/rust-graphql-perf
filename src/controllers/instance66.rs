...
pub struct EventInstanceQueries66;

#[Object]
impl EventInstanceQueries66{
    async fn event_instances66(
        &self,
    ) -> Result<Vec<EventInstance66Object>, anyhow::Error> {
        let ret = vec![EventInstance66{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations66;

#[Object]
impl EventInstanceMutations66{
    async fn create66(
        &self,
        _input: EventInstanceCreateInput66,
    ) -> Result<EventInstance66Object, anyhow::Error> {
        let ret = EventInstance66{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput66 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance66);

#[Object(name = "EventInstance66")]
impl EventInstance66Object {
...
simpleObject!(EventInstance66, title: String, description: String);

complexObject!(EventInstance66, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
