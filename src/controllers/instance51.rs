...
pub struct EventInstanceQueries51;

#[Object]
impl EventInstanceQueries51{
    async fn event_instances51(
        &self,
    ) -> Result<Vec<EventInstance51Object>, anyhow::Error> {
        let ret = vec![EventInstance51{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations51;

#[Object]
impl EventInstanceMutations51{
    async fn create51(
        &self,
        _input: EventInstanceCreateInput51,
    ) -> Result<EventInstance51Object, anyhow::Error> {
        let ret = EventInstance51{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput51 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance51);

#[Object(name = "EventInstance51")]
impl EventInstance51Object {
...
simpleObject!(EventInstance51, title: String, description: String);

complexObject!(EventInstance51, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
