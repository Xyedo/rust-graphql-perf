...
pub struct EventInstanceQueries40;

#[Object]
impl EventInstanceQueries40{
    async fn event_instances40(
        &self,
    ) -> Result<Vec<EventInstance40Object>, anyhow::Error> {
        let ret = vec![EventInstance40{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations40;

#[Object]
impl EventInstanceMutations40{
    async fn create40(
        &self,
        _input: EventInstanceCreateInput40,
    ) -> Result<EventInstance40Object, anyhow::Error> {
        let ret = EventInstance40{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput40 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance40);

#[Object(name = "EventInstance40")]
impl EventInstance40Object {
...
simpleObject!(EventInstance40, title: String, description: String);

complexObject!(EventInstance40, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
