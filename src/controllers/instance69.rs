...
pub struct EventInstanceQueries69;

#[Object]
impl EventInstanceQueries69{
    async fn event_instances69(
        &self,
    ) -> Result<Vec<EventInstance69Object>, anyhow::Error> {
        let ret = vec![EventInstance69{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations69;

#[Object]
impl EventInstanceMutations69{
    async fn create69(
        &self,
        _input: EventInstanceCreateInput69,
    ) -> Result<EventInstance69Object, anyhow::Error> {
        let ret = EventInstance69{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput69 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance69);

#[Object(name = "EventInstance69")]
impl EventInstance69Object {
...
simpleObject!(EventInstance69, title: String, description: String);

complexObject!(EventInstance69, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
