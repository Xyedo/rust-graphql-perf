...
pub struct EventInstanceQueries78;

#[Object]
impl EventInstanceQueries78{
    async fn event_instances78(
        &self,
    ) -> Result<Vec<EventInstance78Object>, anyhow::Error> {
        let ret = vec![EventInstance78{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations78;

#[Object]
impl EventInstanceMutations78{
    async fn create78(
        &self,
        _input: EventInstanceCreateInput78,
    ) -> Result<EventInstance78Object, anyhow::Error> {
        let ret = EventInstance78{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput78 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance78);

#[Object(name = "EventInstance78")]
impl EventInstance78Object {
...
simpleObject!(EventInstance78, title: String, description: String);

complexObject!(EventInstance78, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
