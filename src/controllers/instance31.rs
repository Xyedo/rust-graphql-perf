...
pub struct EventInstanceQueries31;

#[Object]
impl EventInstanceQueries31{
    async fn event_instances31(
        &self,
    ) -> Result<Vec<EventInstance31Object>, anyhow::Error> {
        let ret = vec![EventInstance31{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations31;

#[Object]
impl EventInstanceMutations31{
    async fn create31(
        &self,
        _input: EventInstanceCreateInput31,
    ) -> Result<EventInstance31Object, anyhow::Error> {
        let ret = EventInstance31{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput31 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance31);

#[Object(name = "EventInstance31")]
impl EventInstance31Object {
...
simpleObject!(EventInstance31, title: String, description: String);

complexObject!(EventInstance31, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
