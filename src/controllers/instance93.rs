...
pub struct EventInstanceQueries93;

#[Object]
impl EventInstanceQueries93{
    async fn event_instances93(
        &self,
    ) -> Result<Vec<EventInstance93Object>, anyhow::Error> {
        let ret = vec![EventInstance93{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations93;

#[Object]
impl EventInstanceMutations93{
    async fn create93(
        &self,
        _input: EventInstanceCreateInput93,
    ) -> Result<EventInstance93Object, anyhow::Error> {
        let ret = EventInstance93{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput93 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance93);

#[Object(name = "EventInstance93")]
impl EventInstance93Object {
...
simpleObject!(EventInstance93, title: String, description: String);

complexObject!(EventInstance93, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
