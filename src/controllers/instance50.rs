...
pub struct EventInstanceQueries50;

#[Object]
impl EventInstanceQueries50{
    async fn event_instances50(
        &self,
    ) -> Result<Vec<EventInstance50Object>, anyhow::Error> {
        let ret = vec![EventInstance50{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations50;

#[Object]
impl EventInstanceMutations50{
    async fn create50(
        &self,
        _input: EventInstanceCreateInput50,
    ) -> Result<EventInstance50Object, anyhow::Error> {
        let ret = EventInstance50{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput50 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance50);

#[Object(name = "EventInstance50")]
impl EventInstance50Object {
...
simpleObject!(EventInstance50, title: String, description: String);

complexObject!(EventInstance50, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
