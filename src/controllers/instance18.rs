...
pub struct EventInstanceQueries18;

#[Object]
impl EventInstanceQueries18{
    async fn event_instances18(
        &self,
    ) -> Result<Vec<EventInstance18Object>, anyhow::Error> {
        let ret = vec![EventInstance18{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations18;

#[Object]
impl EventInstanceMutations18{
    async fn create18(
        &self,
        _input: EventInstanceCreateInput18,
    ) -> Result<EventInstance18Object, anyhow::Error> {
        let ret = EventInstance18{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput18 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance18);

#[Object(name = "EventInstance18")]
impl EventInstance18Object {
...
simpleObject!(EventInstance18, title: String, description: String);

complexObject!(EventInstance18, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
