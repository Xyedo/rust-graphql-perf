...
pub struct EventInstanceQueries14;

#[Object]
impl EventInstanceQueries14{
    async fn event_instances14(
        &self,
    ) -> Result<Vec<EventInstance14Object>, anyhow::Error> {
        let ret = vec![EventInstance14{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations14;

#[Object]
impl EventInstanceMutations14{
    async fn create14(
        &self,
        _input: EventInstanceCreateInput14,
    ) -> Result<EventInstance14Object, anyhow::Error> {
        let ret = EventInstance14{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput14 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance14);

#[Object(name = "EventInstance14")]
impl EventInstance14Object {
...
simpleObject!(EventInstance14, title: String, description: String);

complexObject!(EventInstance14, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
