...
derive_graphql_wrapper!(EventInstance1);

#[Object(name = "EventInstance1")]
impl EventInstance1Object {
...
simpleObject!(EventInstance1, title: String, description: String);

complexObject!(EventInstance1, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
