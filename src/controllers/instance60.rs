...
pub struct EventInstanceQueries60;

#[Object]
impl EventInstanceQueries60{
    async fn event_instances60(
        &self,
    ) -> Result<Vec<EventInstance60Object>, anyhow::Error> {
        let ret = vec![EventInstance60{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations60;

#[Object]
impl EventInstanceMutations60{
    async fn create60(
        &self,
        _input: EventInstanceCreateInput60,
    ) -> Result<EventInstance60Object, anyhow::Error> {
        let ret = EventInstance60{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput60 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance60);

#[Object(name = "EventInstance60")]
impl EventInstance60Object {
...
simpleObject!(EventInstance60, title: String, description: String);

complexObject!(EventInstance60, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
