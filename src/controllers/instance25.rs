...
pub struct EventInstanceQueries25;

#[Object]
impl EventInstanceQueries25{
    async fn event_instances25(
        &self,
    ) -> Result<Vec<EventInstance25Object>, anyhow::Error> {
        let ret = vec![EventInstance25{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations25;

#[Object]
impl EventInstanceMutations25{
    async fn create25(
        &self,
        _input: EventInstanceCreateInput25,
    ) -> Result<EventInstance25Object, anyhow::Error> {
        let ret = EventInstance25{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput25 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance25);

#[Object(name = "EventInstance25")]
impl EventInstance25Object {
...
simpleObject!(EventInstance25, title: String, description: String);

complexObject!(EventInstance25, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
