...
pub struct EventInstanceQueries67;

#[Object]
impl EventInstanceQueries67{
    async fn event_instances67(
        &self,
    ) -> Result<Vec<EventInstance67Object>, anyhow::Error> {
        let ret = vec![EventInstance67{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations67;

#[Object]
impl EventInstanceMutations67{
    async fn create67(
        &self,
        _input: EventInstanceCreateInput67,
    ) -> Result<EventInstance67Object, anyhow::Error> {
        let ret = EventInstance67{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput67 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance67);

#[Object(name = "EventInstance67")]
impl EventInstance67Object {
...
simpleObject!(EventInstance67, title: String, description: String);

complexObject!(EventInstance67, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
