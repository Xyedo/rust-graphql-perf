...
pub struct EventInstanceQueries28;

#[Object]
impl EventInstanceQueries28{
    async fn event_instances28(
        &self,
    ) -> Result<Vec<EventInstance28Object>, anyhow::Error> {
        let ret = vec![EventInstance28{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations28;

#[Object]
impl EventInstanceMutations28{
    async fn create28(
        &self,
        _input: EventInstanceCreateInput28,
    ) -> Result<EventInstance28Object, anyhow::Error> {
        let ret = EventInstance28{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput28 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance28);

#[Object(name = "EventInstance28")]
impl EventInstance28Object {
...
simpleObject!(EventInstance28, title: String, description: String);

complexObject!(EventInstance28, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
