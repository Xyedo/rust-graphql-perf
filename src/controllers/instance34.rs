...
pub struct EventInstanceQueries34;

#[Object]
impl EventInstanceQueries34{
    async fn event_instances34(
        &self,
    ) -> Result<Vec<EventInstance34Object>, anyhow::Error> {
        let ret = vec![EventInstance34{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations34;

#[Object]
impl EventInstanceMutations34{
    async fn create34(
        &self,
        _input: EventInstanceCreateInput34,
    ) -> Result<EventInstance34Object, anyhow::Error> {
        let ret = EventInstance34{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput34 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance34);

#[Object(name = "EventInstance34")]
impl EventInstance34Object {
...
simpleObject!(EventInstance34, title: String, description: String);

complexObject!(EventInstance34, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
