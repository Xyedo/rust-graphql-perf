...
impl EventInstanceQueries87 {
    ...
    async fn event_instances87(&self,  _ctx: &Context<'_>) -> Result<Vec<EventInstance87Object>, anyhow::Error> {
...
impl EventInstanceMutations87 {
    async fn create87(
        &self,
        _input: EventInstanceCreateInput87,
    ) -> Result<EventInstance87Object, anyhow::Error> {
