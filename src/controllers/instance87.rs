...
pub struct EventInstanceQueries87;

#[Object]
impl EventInstanceQueries87 {
    async fn event_instances87(&self) -> Result<Vec<EventInstance87Object>, anyhow::Error> {
        let ret = vec![EventInstance87 {
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations87;

#[Object]
impl EventInstanceMutations87 {
    async fn create87(&self, _input: EventInstanceCreateInput87) -> Result<EventInstance87Object, anyhow::Error> {
        let ret = EventInstance87 {
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput87 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance87);

#[Object(name = "EventInstance87")]
impl EventInstance87Object {
...
simpleObject!(EventInstance87, title: String, description: String);

complexObject!(EventInstance87, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
