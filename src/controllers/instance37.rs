...
pub struct EventInstanceQueries37;

#[Object]
impl EventInstanceQueries37{
    async fn event_instances37(
        &self,
    ) -> Result<Vec<EventInstance37Object>, anyhow::Error> {
        let ret = vec![EventInstance37{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations37;

#[Object]
impl EventInstanceMutations37{
    async fn create37(
        &self,
        _input: EventInstanceCreateInput37,
    ) -> Result<EventInstance37Object, anyhow::Error> {
        let ret = EventInstance37{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput37 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance37);

#[Object(name = "EventInstance37")]
impl EventInstance37Object {
...
simpleObject!(EventInstance37, title: String, description: String);

complexObject!(EventInstance37, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
