...
pub struct EventInstanceQueries84;

#[Object]
impl EventInstanceQueries84{
    async fn event_instances84(
        &self,
    ) -> Result<Vec<EventInstance84Object>, anyhow::Error> {
        let ret = vec![EventInstance84{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations84;

#[Object]
impl EventInstanceMutations84{
    async fn create84(
        &self,
        _input: EventInstanceCreateInput84,
    ) -> Result<EventInstance84Object, anyhow::Error> {
        let ret = EventInstance84{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput84 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance84);

#[Object(name = "EventInstance84")]
impl EventInstance84Object {
...
simpleObject!(EventInstance84, title: String, description: String);

complexObject!(EventInstance84, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
