...
pub struct EventInstanceQueries33;

#[Object]
impl EventInstanceQueries33{
    async fn event_instances33(
        &self,
    ) -> Result<Vec<EventInstance33Object>, anyhow::Error> {
        let ret = vec![EventInstance33{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations33;

#[Object]
impl EventInstanceMutations33{
    async fn create33(
        &self,
        _input: EventInstanceCreateInput33,
    ) -> Result<EventInstance33Object, anyhow::Error> {
        let ret = EventInstance33{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput33 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance33);

#[Object(name = "EventInstance33")]
impl EventInstance33Object {
...
simpleObject!(EventInstance33, title: String, description: String);

complexObject!(EventInstance33, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
