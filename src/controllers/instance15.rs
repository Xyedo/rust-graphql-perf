...
pub struct EventInstanceQueries15;

#[Object]
impl EventInstanceQueries15{
    async fn event_instances15(
        &self,
    ) -> Result<Vec<EventInstance15Object>, anyhow::Error> {
        let ret = vec![EventInstance15{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations15;

#[Object]
impl EventInstanceMutations15{
    async fn create15(
        &self,
        _input: EventInstanceCreateInput15,
    ) -> Result<EventInstance15Object, anyhow::Error> {
        let ret = EventInstance15{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput15 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance15);

#[Object(name = "EventInstance15")]
impl EventInstance15Object {
...
simpleObject!(EventInstance15, title: String, description: String);

complexObject!(EventInstance15, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
