...
pub struct EventInstanceQueries63;

#[Object]
impl EventInstanceQueries63{
    async fn event_instances63(
        &self,
    ) -> Result<Vec<EventInstance63Object>, anyhow::Error> {
        let ret = vec![EventInstance63{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations63;

#[Object]
impl EventInstanceMutations63{
    async fn create63(
        &self,
        _input: EventInstanceCreateInput63,
    ) -> Result<EventInstance63Object, anyhow::Error> {
        let ret = EventInstance63{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput63 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance63);

#[Object(name = "EventInstance63")]
impl EventInstance63Object {
...
simpleObject!(EventInstance63, title: String, description: String);

complexObject!(EventInstance63, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
