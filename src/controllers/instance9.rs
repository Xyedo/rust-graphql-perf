...
pub struct EventInstanceQueries9;

#[Object]
impl EventInstanceQueries9{
    async fn event_instances9(
        &self,
    ) -> Result<Vec<EventInstance9Object>, anyhow::Error> {
        let ret = vec![EventInstance9{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations9;

#[Object]
impl EventInstanceMutations9{
    async fn create9(
        &self,
        _input: EventInstanceCreateInput9,
    ) -> Result<EventInstance9Object, anyhow::Error> {
        let ret = EventInstance9{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput9 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance9);

#[Object(name = "EventInstance9")]
impl EventInstance9Object {
...
simpleObject!(EventInstance9, title: String, description: String);

complexObject!(EventInstance9, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
