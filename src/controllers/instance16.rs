...
pub struct EventInstanceQueries16;

#[Object]
impl EventInstanceQueries16{
    async fn event_instances16(
        &self,
    ) -> Result<Vec<EventInstance16Object>, anyhow::Error> {
        let ret = vec![EventInstance16{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations16;

#[Object]
impl EventInstanceMutations16{
    async fn create16(
        &self,
        _input: EventInstanceCreateInput16,
    ) -> Result<EventInstance16Object, anyhow::Error> {
        let ret = EventInstance16{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput16 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance16);

#[Object(name = "EventInstance16")]
impl EventInstance16Object {
...
simpleObject!(EventInstance16, title: String, description: String);

complexObject!(EventInstance16, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
