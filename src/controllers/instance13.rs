...
pub struct EventInstanceQueries13;

#[Object]
impl EventInstanceQueries13{
    async fn event_instances13(
        &self,
    ) -> Result<Vec<EventInstance13Object>, anyhow::Error> {
        let ret = vec![EventInstance13{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations13;

#[Object]
impl EventInstanceMutations13{
    async fn create13(
        &self,
        _input: EventInstanceCreateInput13,
    ) -> Result<EventInstance13Object, anyhow::Error> {
        let ret = EventInstance13{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput13 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance13);

#[Object(name = "EventInstance13")]
impl EventInstance13Object {
...
simpleObject!(EventInstance13, title: String, description: String);

complexObject!(EventInstance13, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
