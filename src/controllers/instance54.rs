...
pub struct EventInstanceQueries54;

#[Object]
impl EventInstanceQueries54{
    async fn event_instances54(
        &self,
    ) -> Result<Vec<EventInstance54Object>, anyhow::Error> {
        let ret = vec![EventInstance54{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations54;

#[Object]
impl EventInstanceMutations54{
    async fn create54(
        &self,
        _input: EventInstanceCreateInput54,
    ) -> Result<EventInstance54Object, anyhow::Error> {
        let ret = EventInstance54{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput54 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance54);

#[Object(name = "EventInstance54")]
impl EventInstance54Object {
...
simpleObject!(EventInstance54, title: String, description: String);

complexObject!(EventInstance54, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
