...
pub struct EventInstanceQueries29;

#[Object]
impl EventInstanceQueries29{
    async fn event_instances29(
        &self,
    ) -> Result<Vec<EventInstance29Object>, anyhow::Error> {
        let ret = vec![EventInstance29{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations29;

#[Object]
impl EventInstanceMutations29{
    async fn create29(
        &self,
        _input: EventInstanceCreateInput29,
    ) -> Result<EventInstance29Object, anyhow::Error> {
        let ret = EventInstance29{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput29 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance29);

#[Object(name = "EventInstance29")]
impl EventInstance29Object {
...
simpleObject!(EventInstance29, title: String, description: String);

complexObject!(EventInstance29, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
