...
pub struct EventInstanceQueries42;

#[Object]
impl EventInstanceQueries42{
    async fn event_instances42(
        &self,
    ) -> Result<Vec<EventInstance42Object>, anyhow::Error> {
        let ret = vec![EventInstance42{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations42;

#[Object]
impl EventInstanceMutations42{
    async fn create42(
        &self,
        _input: EventInstanceCreateInput42,
    ) -> Result<EventInstance42Object, anyhow::Error> {
        let ret = EventInstance42{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput42 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance42);

#[Object(name = "EventInstance42")]
impl EventInstance42Object {
...
simpleObject!(EventInstance42, title: String, description: String);

complexObject!(EventInstance42, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
