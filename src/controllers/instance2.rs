...
derive_graphql_wrapper!(EventInstance2);

#[Object(name = "EventInstance2")]
impl EventInstance2Object {
...
simpleObject!(EventInstance2, title: String, description: String);

complexObject!(EventInstance2, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
