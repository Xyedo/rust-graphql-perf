...
pub struct EventInstanceQueries94;

#[Object]
impl EventInstanceQueries94 {
	async fn event_instances94(&self) -> Result<Vec<EventInstance94Object>, anyhow::Error> {
		let ret = vec![EventInstance94 {
			title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations94;

#[Object]
impl EventInstanceMutations94 {
	async fn create94(&self, _input: EventInstanceCreateInput94) -> Result<EventInstance94Object, anyhow::Error> {
		let ret = EventInstance94 {
			title: "a".to_string(),
			description: "a".to_string(),
			from_date: Utc::now(),
			to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput94 {
	title: String,
	description: String,
...
derive_graphql_wrapper!(EventInstance94);

#[Object(name = "EventInstance94")]
impl EventInstance94Object {
...
simpleObject!(EventInstance94, title: String, description: String);

complexObject!(EventInstance94, {
	from_date: DateTime<Utc>,
	to_date: DateTime<Utc>,
	start_transition_mins: i16,
	end_transition_mins: i16,
