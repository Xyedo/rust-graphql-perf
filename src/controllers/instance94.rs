...
impl EventInstanceQueries94 {
    ...
    async fn event_instances94(&self,  _ctx: &Context<'_>) -> Result<Vec<EventInstance94Object>, anyhow::Error> {
...
impl EventInstanceMutations94 {
    async fn create94(
        &self,
        _input: EventInstanceCreateInput94,
    ) -> Result<EventInstance94Object, anyhow::Error> {
