...
pub struct EventInstanceQueries22;

#[Object]
impl EventInstanceQueries22{
    async fn event_instances22(
        &self,
    ) -> Result<Vec<EventInstance22Object>, anyhow::Error> {
        let ret = vec![EventInstance22{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations22;

#[Object]
impl EventInstanceMutations22{
    async fn create22(
        &self,
        _input: EventInstanceCreateInput22,
    ) -> Result<EventInstance22Object, anyhow::Error> {
        let ret = EventInstance22{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput22 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance22);

#[Object(name = "EventInstance22")]
impl EventInstance22Object {
...
simpleObject!(EventInstance22, title: String, description: String);

complexObject!(EventInstance22, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
