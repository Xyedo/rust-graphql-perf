...
pub struct EventInstanceQueries32;

#[Object]
impl EventInstanceQueries32{
    async fn event_instances32(
        &self,
    ) -> Result<Vec<EventInstance32Object>, anyhow::Error> {
        let ret = vec![EventInstance32{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations32;

#[Object]
impl EventInstanceMutations32{
    async fn create32(
        &self,
        _input: EventInstanceCreateInput32,
    ) -> Result<EventInstance32Object, anyhow::Error> {
        let ret = EventInstance32{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput32 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance32);

#[Object(name = "EventInstance32")]
impl EventInstance32Object {
...
simpleObject!(EventInstance32, title: String, description: String);

complexObject!(EventInstance32, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
