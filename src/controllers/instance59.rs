...
pub struct EventInstanceQueries59;

#[Object]
impl EventInstanceQueries59{
    async fn event_instances59(
        &self,
    ) -> Result<Vec<EventInstance59Object>, anyhow::Error> {
        let ret = vec![EventInstance59{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations59;

#[Object]
impl EventInstanceMutations59{
    async fn create59(
        &self,
        _input: EventInstanceCreateInput59,
    ) -> Result<EventInstance59Object, anyhow::Error> {
        let ret = EventInstance59{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput59 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance59);

#[Object(name = "EventInstance59")]
impl EventInstance59Object {
...
simpleObject!(EventInstance59, title: String, description: String);

complexObject!(EventInstance59, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
