...
pub struct EventInstanceQueries39;

#[Object]
impl EventInstanceQueries39{
    async fn event_instances39(
        &self,
    ) -> Result<Vec<EventInstance39Object>, anyhow::Error> {
        let ret = vec![EventInstance39{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations39;

#[Object]
impl EventInstanceMutations39{
    async fn create39(
        &self,
        _input: EventInstanceCreateInput39,
    ) -> Result<EventInstance39Object, anyhow::Error> {
        let ret = EventInstance39{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput39 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance39);

#[Object(name = "EventInstance39")]
impl EventInstance39Object {
...
simpleObject!(EventInstance39, title: String, description: String);

complexObject!(EventInstance39, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
