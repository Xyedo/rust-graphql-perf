...
pub struct EventInstanceQueries91;

#[Object]
impl EventInstanceQueries91 {
    async fn event_instances91(&self) -> Result<Vec<EventInstance91Object>, anyhow::Error> {
        let ret = vec![EventInstance91 {
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations91;

#[Object]
impl EventInstanceMutations91 {
    async fn create91(&self, _input: EventInstanceCreateInput91) -> Result<EventInstance91Object, anyhow::Error> {
        let ret = EventInstance91 {
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
simpleObject!(EventInstance91, title: String, description: String);

complexObject!(EventInstance91, {
...
#[derive(InputObject)]
struct EventInstanceCreateInput91 {
    title: String,
    description: String,
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
...
derive_graphql_wrapper!(EventInstance91);

#[Object(name = "EventInstance91")]
impl EventInstance91Object {
