...
pub struct EventInstanceQueries35;

#[Object]
impl EventInstanceQueries35{
    async fn event_instances35(
        &self,
    ) -> Result<Vec<EventInstance35Object>, anyhow::Error> {
        let ret = vec![EventInstance35{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations35;

#[Object]
impl EventInstanceMutations35{
    async fn create35(
        &self,
        _input: EventInstanceCreateInput35,
    ) -> Result<EventInstance35Object, anyhow::Error> {
        let ret = EventInstance35{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput35 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance35);

#[Object(name = "EventInstance35")]
impl EventInstance35Object {
...
simpleObject!(EventInstance35, title: String, description: String);

complexObject!(EventInstance35, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
