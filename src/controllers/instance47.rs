...
pub struct EventInstanceQueries47;

#[Object]
impl EventInstanceQueries47{
    async fn event_instances47(
        &self,
    ) -> Result<Vec<EventInstance47Object>, anyhow::Error> {
        let ret = vec![EventInstance47{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations47;

#[Object]
impl EventInstanceMutations47{
    async fn create47(
        &self,
        _input: EventInstanceCreateInput47,
    ) -> Result<EventInstance47Object, anyhow::Error> {
        let ret = EventInstance47{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput47 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance47);

#[Object(name = "EventInstance47")]
impl EventInstance47Object {
...
simpleObject!(EventInstance47, title: String, description: String);

complexObject!(EventInstance47, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
