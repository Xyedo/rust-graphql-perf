...
pub struct EventInstanceQueries72;

#[Object]
impl EventInstanceQueries72{
    async fn event_instances72(
        &self,
    ) -> Result<Vec<EventInstance72Object>, anyhow::Error> {
        let ret = vec![EventInstance72{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations72;

#[Object]
impl EventInstanceMutations72{
    async fn create72(
        &self,
        _input: EventInstanceCreateInput72,
    ) -> Result<EventInstance72Object, anyhow::Error> {
        let ret = EventInstance72{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput72 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance72);

#[Object(name = "EventInstance72")]
impl EventInstance72Object {
...
simpleObject!(EventInstance72, title: String, description: String);

complexObject!(EventInstance72, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
