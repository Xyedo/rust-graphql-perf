...
pub struct EventInstanceQueries17;

#[Object]
impl EventInstanceQueries17{
    async fn event_instances17(
        &self,
    ) -> Result<Vec<EventInstance17Object>, anyhow::Error> {
        let ret = vec![EventInstance17{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations17;

#[Object]
impl EventInstanceMutations17{
    async fn create17(
        &self,
        _input: EventInstanceCreateInput17,
    ) -> Result<EventInstance17Object, anyhow::Error> {
        let ret = EventInstance17{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput17 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance17);

#[Object(name = "EventInstance17")]
impl EventInstance17Object {
...
simpleObject!(EventInstance17, title: String, description: String);

complexObject!(EventInstance17, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
