...
#[derive(InputObject)]
struct EventInstanceCreateInput79 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance79);

#[Object(name = "EventInstance79")]
impl EventInstance79Object {
