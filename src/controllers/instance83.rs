...
pub struct EventInstanceQueries83;

#[Object]
impl EventInstanceQueries83{
    async fn event_instances83(
        &self,
    ) -> Result<Vec<EventInstance83Object>, anyhow::Error> {
        let ret = vec![EventInstance83{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations83;

#[Object]
impl EventInstanceMutations83{
    async fn create83(
        &self,
        _input: EventInstanceCreateInput83,
    ) -> Result<EventInstance83Object, anyhow::Error> {
        let ret = EventInstance83{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput83 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance83);

#[Object(name = "EventInstance83")]
impl EventInstance83Object {
...
simpleObject!(EventInstance83, title: String, description: String);

complexObject!(EventInstance83, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
