...
pub struct EventInstanceQueries38;

#[Object]
impl EventInstanceQueries38{
    async fn event_instances38(
        &self,
    ) -> Result<Vec<EventInstance38Object>, anyhow::Error> {
        let ret = vec![EventInstance38{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations38;

#[Object]
impl EventInstanceMutations38{
    async fn create38(
        &self,
        _input: EventInstanceCreateInput38,
    ) -> Result<EventInstance38Object, anyhow::Error> {
        let ret = EventInstance38{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput38 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance38);

#[Object(name = "EventInstance38")]
impl EventInstance38Object {
...
simpleObject!(EventInstance38, title: String, description: String);

complexObject!(EventInstance38, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
