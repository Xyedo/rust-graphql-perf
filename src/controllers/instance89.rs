...
impl EventInstanceQueries89 {
    ...
    async fn event_instances89(&self,  _ctx: &Context<'_>) -> Result<Vec<EventInstance89Object>, anyhow::Error> {
...
impl EventInstanceMutations89 {
    async fn create89(
        &self,
        _input: EventInstanceCreateInput89,
    ) -> Result<EventInstance89Object, anyhow::Error> {
