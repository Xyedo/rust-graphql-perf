...
pub struct EventInstanceQueries89;

#[Object]
impl EventInstanceQueries89 {
	async fn event_instances89(&self) -> Result<Vec<EventInstance89Object>, anyhow::Error> {
		let ret = vec![EventInstance89 {
			title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations89;

#[Object]
impl EventInstanceMutations89 {
	async fn create89(&self, _input: EventInstanceCreateInput89) -> Result<EventInstance89Object, anyhow::Error> {
		let ret = EventInstance89 {
			title: "a".to_string(),
			description: "a".to_string(),
			from_date: Utc::now(),
			to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput89 {
	title: String,
	description: String,
...
#[Object(name = "EventInstance89")]
impl EventInstance89Object {
