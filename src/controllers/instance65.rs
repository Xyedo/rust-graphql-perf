...
pub struct EventInstanceQueries65;

#[Object]
impl EventInstanceQueries65{
    async fn event_instances65(
        &self,
    ) -> Result<Vec<EventInstance65Object>, anyhow::Error> {
        let ret = vec![EventInstance65{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations65;

#[Object]
impl EventInstanceMutations65{
    async fn create65(
        &self,
        _input: EventInstanceCreateInput65,
    ) -> Result<EventInstance65Object, anyhow::Error> {
        let ret = EventInstance65{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput65 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance65);

#[Object(name = "EventInstance65")]
impl EventInstance65Object {
...
simpleObject!(EventInstance65, title: String, description: String);

complexObject!(EventInstance65, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
