...
pub struct EventInstanceQueries36;

#[Object]
impl EventInstanceQueries36{
    async fn event_instances36(
        &self,
    ) -> Result<Vec<EventInstance36Object>, anyhow::Error> {
        let ret = vec![EventInstance36{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations36;

#[Object]
impl EventInstanceMutations36{
    async fn create36(
        &self,
        _input: EventInstanceCreateInput36,
    ) -> Result<EventInstance36Object, anyhow::Error> {
        let ret = EventInstance36{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput36 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance36);

#[Object(name = "EventInstance36")]
impl EventInstance36Object {
...
simpleObject!(EventInstance36, title: String, description: String);

complexObject!(EventInstance36, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
