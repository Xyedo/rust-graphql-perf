...
pub struct EventInstanceQueries82;

#[Object]
impl EventInstanceQueries82{
    async fn event_instances82(
        &self,
    ) -> Result<Vec<EventInstance82Object>, anyhow::Error> {
        let ret = vec![EventInstance82{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations82;

#[Object]
impl EventInstanceMutations82{
    async fn create82(
        &self,
        _input: EventInstanceCreateInput82,
    ) -> Result<EventInstance82Object, anyhow::Error> {
        let ret = EventInstance82{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput82 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance82);

#[Object(name = "EventInstance82")]
impl EventInstance82Object {
...
simpleObject!(EventInstance82, title: String, description: String);

complexObject!(EventInstance82, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
