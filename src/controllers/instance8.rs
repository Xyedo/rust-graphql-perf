...
pub struct EventInstanceQueries8;

#[Object]
impl EventInstanceQueries8{
    async fn event_instances8(
        &self,
    ) -> Result<Vec<EventInstance8Object>, anyhow::Error> {
        let ret = vec![EventInstance8{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations8;

#[Object]
impl EventInstanceMutations8{
    async fn create8(
        &self,
        _input: EventInstanceCreateInput8,
    ) -> Result<EventInstance8Object, anyhow::Error> {
        let ret = EventInstance8{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput8 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance8);

#[Object(name = "EventInstance8")]
impl EventInstance8Object {
...
simpleObject!(EventInstance8, title: String, description: String);

complexObject!(EventInstance8, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
