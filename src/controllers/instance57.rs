...
pub struct EventInstanceQueries57;

#[Object]
impl EventInstanceQueries57{
    async fn event_instances57(
        &self,
    ) -> Result<Vec<EventInstance57Object>, anyhow::Error> {
        let ret = vec![EventInstance57{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations57;

#[Object]
impl EventInstanceMutations57{
    async fn create57(
        &self,
        _input: EventInstanceCreateInput57,
    ) -> Result<EventInstance57Object, anyhow::Error> {
        let ret = EventInstance57{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput57 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance57);

#[Object(name = "EventInstance57")]
impl EventInstance57Object {
...
simpleObject!(EventInstance57, title: String, description: String);

complexObject!(EventInstance57, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
