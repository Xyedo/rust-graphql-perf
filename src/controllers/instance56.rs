...
pub struct EventInstanceQueries56;

#[Object]
impl EventInstanceQueries56{
    async fn event_instances56(
        &self,
    ) -> Result<Vec<EventInstance56Object>, anyhow::Error> {
        let ret = vec![EventInstance56{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations56;

#[Object]
impl EventInstanceMutations56{
    async fn create56(
        &self,
        _input: EventInstanceCreateInput56,
    ) -> Result<EventInstance56Object, anyhow::Error> {
        let ret = EventInstance56{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput56 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance56);

#[Object(name = "EventInstance56")]
impl EventInstance56Object {
...
simpleObject!(EventInstance56, title: String, description: String);

complexObject!(EventInstance56, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
