...
pub struct EventInstanceQueries81;

#[Object]
impl EventInstanceQueries81{
    async fn event_instances81(
        &self,
    ) -> Result<Vec<EventInstance81Object>, anyhow::Error> {
        let ret = vec![EventInstance81{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations81;

#[Object]
impl EventInstanceMutations81{
    async fn create81(
        &self,
        _input: EventInstanceCreateInput81,
    ) -> Result<EventInstance81Object, anyhow::Error> {
        let ret = EventInstance81{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput81 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance81);

#[Object(name = "EventInstance81")]
impl EventInstance81Object {
...
simpleObject!(EventInstance81, title: String, description: String);

complexObject!(EventInstance81, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
