...
pub struct EventInstanceQueries95;

#[Object]
impl EventInstanceQueries95 {
    async fn event_instances95(&self) -> Result<Vec<EventInstance95Object>, anyhow::Error> {
        let ret = vec![EventInstance95 {
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations95;

#[Object]
impl EventInstanceMutations95 {
    async fn create95(&self, _input: EventInstanceCreateInput95) -> Result<EventInstance95Object, anyhow::Error> {
        let ret = EventInstance95 {
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput95 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance95);

#[Object(name = "EventInstance95")]
impl EventInstance95Object {
...
simpleObject!(EventInstance95, title: String, description: String);

complexObject!(EventInstance95, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
