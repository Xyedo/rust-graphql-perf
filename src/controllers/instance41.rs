...
pub struct EventInstanceQueries41;

#[Object]
impl EventInstanceQueries41{
    async fn event_instances41(
        &self,
    ) -> Result<Vec<EventInstance41Object>, anyhow::Error> {
        let ret = vec![EventInstance41{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations41;

#[Object]
impl EventInstanceMutations41{
    async fn create41(
        &self,
        _input: EventInstanceCreateInput41,
    ) -> Result<EventInstance41Object, anyhow::Error> {
        let ret = EventInstance41{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput41 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance41);

#[Object(name = "EventInstance41")]
impl EventInstance41Object {
...
simpleObject!(EventInstance41, title: String, description: String);

complexObject!(EventInstance41, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
