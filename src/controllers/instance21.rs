...
pub struct EventInstanceQueries21;

#[Object]
impl EventInstanceQueries21{
    async fn event_instances21(
        &self,
    ) -> Result<Vec<EventInstance21Object>, anyhow::Error> {
        let ret = vec![EventInstance21{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations21;

#[Object]
impl EventInstanceMutations21{
    async fn create21(
        &self,
        _input: EventInstanceCreateInput21,
    ) -> Result<EventInstance21Object, anyhow::Error> {
        let ret = EventInstance21{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput21 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance21);

#[Object(name = "EventInstance21")]
impl EventInstance21Object {
...
simpleObject!(EventInstance21, title: String, description: String);

complexObject!(EventInstance21, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
