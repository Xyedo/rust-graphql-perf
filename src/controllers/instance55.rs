...
pub struct EventInstanceQueries55;

#[Object]
impl EventInstanceQueries55{
    async fn event_instances55(
        &self,
    ) -> Result<Vec<EventInstance55Object>, anyhow::Error> {
        let ret = vec![EventInstance55{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations55;

#[Object]
impl EventInstanceMutations55{
    async fn create55(
        &self,
        _input: EventInstanceCreateInput55,
    ) -> Result<EventInstance55Object, anyhow::Error> {
        let ret = EventInstance55{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput55 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance55);

#[Object(name = "EventInstance55")]
impl EventInstance55Object {
...
simpleObject!(EventInstance55, title: String, description: String);

complexObject!(EventInstance55, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
