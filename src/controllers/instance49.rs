...
pub struct EventInstanceQueries49;

#[Object]
impl EventInstanceQueries49{
    async fn event_instances49(
        &self,
    ) -> Result<Vec<EventInstance49Object>, anyhow::Error> {
        let ret = vec![EventInstance49{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations49;

#[Object]
impl EventInstanceMutations49{
    async fn create49(
        &self,
        _input: EventInstanceCreateInput49,
    ) -> Result<EventInstance49Object, anyhow::Error> {
        let ret = EventInstance49{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput49 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance49);

#[Object(name = "EventInstance49")]
impl EventInstance49Object {
...
simpleObject!(EventInstance49, title: String, description: String);

complexObject!(EventInstance49, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
