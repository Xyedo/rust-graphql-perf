...
pub struct EventInstanceQueries71;

#[Object]
impl EventInstanceQueries71{
    async fn event_instances71(
        &self,
    ) -> Result<Vec<EventInstance71Object>, anyhow::Error> {
        let ret = vec![EventInstance71{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations71;

#[Object]
impl EventInstanceMutations71{
    async fn create71(
        &self,
        _input: EventInstanceCreateInput71,
    ) -> Result<EventInstance71Object, anyhow::Error> {
        let ret = EventInstance71{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput71 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance71);

#[Object(name = "EventInstance71")]
impl EventInstance71Object {
...
simpleObject!(EventInstance71, title: String, description: String);

complexObject!(EventInstance71, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
