...
pub struct EventInstanceQueries77;

#[Object]
impl EventInstanceQueries77{
    async fn event_instances77(
        &self,
    ) -> Result<Vec<EventInstance77Object>, anyhow::Error> {
        let ret = vec![EventInstance77{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations77;

#[Object]
impl EventInstanceMutations77{
    async fn create77(
        &self,
        _input: EventInstanceCreateInput77,
    ) -> Result<EventInstance77Object, anyhow::Error> {
        let ret = EventInstance77{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
derive_graphql_wrapper!(EventInstance77);

#[Object(name = "EventInstance77")]
impl EventInstance77Object {
