...
pub struct EventInstanceQueries53;

#[Object]
impl EventInstanceQueries53{
    async fn event_instances53(
        &self,
    ) -> Result<Vec<EventInstance53Object>, anyhow::Error> {
        let ret = vec![EventInstance53{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations53;

#[Object]
impl EventInstanceMutations53{
    async fn create53(
        &self,
        _input: EventInstanceCreateInput53,
    ) -> Result<EventInstance53Object, anyhow::Error> {
        let ret = EventInstance53{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput53 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance53);

#[Object(name = "EventInstance53")]
impl EventInstance53Object {
...
simpleObject!(EventInstance53, title: String, description: String);

complexObject!(EventInstance53, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
