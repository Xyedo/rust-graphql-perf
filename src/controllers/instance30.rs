...
pub struct EventInstanceQueries30;

#[Object]
impl EventInstanceQueries30{
    async fn event_instances30(
        &self,
    ) -> Result<Vec<EventInstance30Object>, anyhow::Error> {
        let ret = vec![EventInstance30{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations30;

#[Object]
impl EventInstanceMutations30{
    async fn create30(
        &self,
        _input: EventInstanceCreateInput30,
    ) -> Result<EventInstance30Object, anyhow::Error> {
        let ret = EventInstance30{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput30 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance30);

#[Object(name = "EventInstance30")]
impl EventInstance30Object {
...
simpleObject!(EventInstance30, title: String, description: String);

complexObject!(EventInstance30, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
