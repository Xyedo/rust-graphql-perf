...
pub struct EventInstanceQueries74;

#[Object]
impl EventInstanceQueries74{
    async fn event_instances74(
        &self,
    ) -> Result<Vec<EventInstance74Object>, anyhow::Error> {
        let ret = vec![EventInstance74{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations74;

#[Object]
impl EventInstanceMutations74{
    async fn create74(
        &self,
        _input: EventInstanceCreateInput74,
    ) -> Result<EventInstance74Object, anyhow::Error> {
        let ret = EventInstance74{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput74 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance74);

#[Object(name = "EventInstance74")]
impl EventInstance74Object {
...
simpleObject!(EventInstance74, title: String, description: String);

complexObject!(EventInstance74, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
