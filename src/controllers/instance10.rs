...
pub struct EventInstanceQueries10;

#[Object]
impl EventInstanceQueries10{
    async fn event_instances10(
        &self,
    ) -> Result<Vec<EventInstance10Object>, anyhow::Error> {
        let ret = vec![EventInstance10{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations10;

#[Object]
impl EventInstanceMutations10{
    async fn create10(
        &self,
        _input: EventInstanceCreateInput10,
    ) -> Result<EventInstance10Object, anyhow::Error> {
        let ret = EventInstance10{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput10 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance10);

#[Object(name = "EventInstance10")]
impl EventInstance10Object {
...
simpleObject!(EventInstance10, title: String, description: String);

complexObject!(EventInstance10, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
