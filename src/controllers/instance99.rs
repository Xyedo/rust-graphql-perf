...
pub struct EventInstanceQueries99;

#[Object]
impl EventInstanceQueries99 {
    async fn event_instances99(&self) -> Result<Vec<EventInstance99Object>, anyhow::Error> {
        let ret = vec![EventInstance99 {
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations99;

#[Object]
impl EventInstanceMutations99 {
    async fn create99(&self, _input: EventInstanceCreateInput99) -> Result<EventInstance99Object, anyhow::Error> {
        let ret = EventInstance99 {
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput99 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance99);

#[Object(name = "EventInstance99")]
impl EventInstance99Object {
...
simpleObject!(EventInstance99, title: String, description: String);

complexObject!(EventInstance99, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
