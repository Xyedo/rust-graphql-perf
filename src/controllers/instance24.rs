...
pub struct EventInstanceQueries24;

#[Object]
impl EventInstanceQueries24{
    async fn event_instances24(
        &self,
    ) -> Result<Vec<EventInstance24Object>, anyhow::Error> {
        let ret = vec![EventInstance24{
            title: "a".to_string(),
...
#[derive(Default, Clone)]
pub struct EventInstanceMutations24;

#[Object]
impl EventInstanceMutations24{
    async fn create24(
        &self,
        _input: EventInstanceCreateInput24,
    ) -> Result<EventInstance24Object, anyhow::Error> {
        let ret = EventInstance24{
            title: "a".to_string(),
            description: "a".to_string(),
            from_date: Utc::now(),
            to_date: Utc::now(),
...
#[derive(InputObject)]
struct EventInstanceCreateInput24 {
    title: String,
    description: String,
...
derive_graphql_wrapper!(EventInstance24);

#[Object(name = "EventInstance24")]
impl EventInstance24Object {
...
simpleObject!(EventInstance24, title: String, description: String);

complexObject!(EventInstance24, {
    from_date: DateTime<Utc>,
    to_date: DateTime<Utc>,
    start_transition_mins: i16,
    end_transition_mins: i16,
